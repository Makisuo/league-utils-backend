...
export class AppController {
  ...
  async getMasteryDataBySummonerName(
    @Res() res,
    @Param('name') name: string,
  ): Promise<JSON> {
  ...
  async getMasteryDataBySummonerNameByChampion(
    ...
    const response = await this.appService.getMasteryDataOfChampionBySummonerName(
      username,
      champion,
    );
    return res.status(HttpStatus.OK).json(response);
  ...
  async getLowestMasteryDataBySummonerName(
    @Res() res,
    @Param('name') name: string,
  ): Promise<JSON> {
  ...
  async getNextMasteryDataBySummonerName(
    @Res() res,
    @Param('name') name: string,
  ): Promise<JSON> {
